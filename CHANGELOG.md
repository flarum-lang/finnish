...
* Poistettu vanhentuneita Flarumin ytimen käännöksiä (versio `2.0` tai suurempi on tuettu).
...
**Poistettu tuki vanhentuneille lisäosille**:
...
Kaikki muutokset: [v1.17.1...v2.0.0](https://github.com/flarum-lang/finnish/compare/v1.17.1...v2.0.0).
...
Kaikki muutokset: [v1.13.0...v1.14.0](https://github.com/flarum-lang/finnish/compare/v1.13.0...v1.14.0).
